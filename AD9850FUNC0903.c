...
//��ʼ��AD9850ģ�������GPIO���š���Щ�������ڷ������ݺͿ����źŸ�AD9850��
...
{
    	dds_fq=FREQ_FACTOR*freq1/100; //��Ƶ��ֵת��ΪAD9850����ĸ�ʽ
	    dds_ph=phase1<<3; //�����ƶ�3λ�Է���AD9850����λ�Ĵ�����ʽ
	    w0=dds_ph;//  w0����dds_ph
	    w4=dds_fq%256;//  w1,w2,w3,w4����dds_fq
	    dds_fq=dds_fq/256;
	    w3=dds_fq%256;
	   	dds_fq=dds_fq/256;
	    w2=dds_fq%256;
	    ...
	    FQ_UD_L; FQ_UD_H; FQ_UD_L;
			//ͨ������FQ_UD����������AD9850�ڲ���Ƶ�ʺ���λֵ��������AD9850����һ���ź�
}
//����������Ƶ��ֵ��freq1��freq2����������λֵ��phase1��phase2����Ȼ�������Щֵ���������AD9850����������ֽڡ�
//����õ��������ֽ�ͨ��ad9850_wr_parrel�������͵�AD9850ģ��