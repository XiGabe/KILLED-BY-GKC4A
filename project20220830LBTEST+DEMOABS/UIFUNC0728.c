...
unsigned char a0_s0[]="chxnb", a0_s1[]="WELCOME", a0_s2[]="PRESS ANY KEY";
unsigned char a1_s0[]="CHOOSE OP MODE",a1_s1[]="DUO INDEP SIGNAL",a1_s2[]="90°PHASE SIGNAL";
unsigned char a2_s0[]="HELLO WORLD",a2_s1[]="BACK";
...
//	a1.str[3]=a1_s3;	a1.x[3]=3;	a1.y[3]=0;	a1.inverse[3]=0;					  ///////act1
	...
	a2.str[1]=a2_s1;	a2.x[1]=3;	a2.y[1]=12;	a2.inverse[1]=0;                 	/////act=2
	act[2]=&a2;	
	...
	a4.str[9]=a4_s9;	a4.x[9]=2;	a4.y[9]=5;	a4.inverse[9]=0;	/////act=4
	act[4]=&a4;
	...
	a5.str[9]=a5_s9;	a5.x[9]=2;	a5.y[9]=5;	a5.inverse[9]=0;		/////act=5
	act[5]=&a5;
	display_ui_act(0);
}
//初始化不同UI状态下的显示信息。
...
void ui_proc101(void)
{
	...
	{
		act[1]->inverse[1]=0;
		act[2]->inverse[1]=1; display_ui_act(2);
		ui_state=201;
	}
